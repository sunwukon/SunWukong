...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	if(pindexBest->nHeight+1 >= 3 && pindexBest->nHeight+1 <= 5000)
    {
		nSubsidy = 50 * COIN;  
    } 
	   if(pindexBest->nHeight+1 >= 5001 && pindexBest->nHeight+1 <= 10000)
    {
        nSubsidy = 100 * COIN;  
    } 
           if(pindexBest->nHeight+1 >= 10001 && pindexBest->nHeight+1 <= 20001)
    {
        nSubsidy = 25 * COIN;  
    } 
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
	...
	if(pindexBest->nHeight+1 >= 0 && pindexBest->nHeight+1 <= 1000)
    {
		nSubsidy = 0 * COIN;  
    }	
	if(pindexBest->nHeight+1 >= 1001 && pindexBest->nHeight+1 <= 20000)
    {
		nSubsidy = 25 * COIN;  
    }
    else if(pindexBest->nHeight+1 >= 20001 && pindexBest->nHeight+1 <= 50000)
    {
		nSubsidy = 20 * COIN;   
    }
    ...
    else if(pindexBest->nHeight+1 >=100001 && pindexBest->nHeight+1 <= 150000)
    {
		nSubsidy = 10 * COIN;  
    }
    else if(pindexBest->nHeight+1 >= 150001 && pindexBest->nHeight+1 <= 200000)
    {
		nSubsidy = 5 * COIN;  
    }
    else if(pindexBest->nHeight+1 >= 200001 && pindexBest->nHeight+1 <= 250000)
    {
		nSubsidy = 2.5 * COIN;  
    }
    else if(pindexBest->nHeight+1 >= 250001 && pindexBest->nHeight+1 <= 300000)
    {
		nSubsidy = 1.25 * COIN;  
    }
    else if(pindexBest->nHeight+1 >= 300001)
    {
		nSubsidy = 0.5 * COIN;  
    }	
...
#ifdef ENABLE_WALLET
// Monkey: attempt to generate suitable proof-of-stake
